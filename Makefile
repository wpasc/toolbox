...
setup: install-cli-tools brew link link-macos link-cursor nvim-plugins tmux-plugins configure-cli-tools
	...
	@echo ""
	@echo "     export PATH=\"$(TOOLBOX_DIR)/scripts:\$$PATH\""
	@echo "     export PATH=\"\$$HOME/.local/bin:\$$PATH\""
	@echo "     source <(fzf --zsh)"
	@echo "     source $(TOOLBOX_DIR)/active/zsh/history.zsh"
	@echo ""
	@echo "  Then:"
	@echo "  1. Open Ghostty (installed via brew cask)"
	...
	@echo "  2. Start tmux with a named session: tmux new -s main"
	@echo "  3. Run: nvim"
